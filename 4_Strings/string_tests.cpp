...
std::vector<CastRelation> getHardcodedCastRelations() {
    return {
        ...
        createCastRelation(1004, 204, 4, 304, "123456789", 1, 404),
...
std::vector<TitleRelation> getHardcodedTitleRelations() {
    return {
        createTitleRelation(1, "?????!!!?$!$", "I1", 1, 1999, 101, "TMX", "1999", "md5sum000000000000000000000000000001"),
        ...
        createTitleRelation(7, "123456789", "I7", 1, 1999, 107, "FCB", "1999", "md5sum000000000000000000000000000007"),
